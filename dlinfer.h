...
public:
    ...
    /**
     * Get top N  predicted elements
     * @param topCount - the quantity of top objects
     * @return vector of InferenceResults objects
     */
    std::vector<InferenceEngineConfigurator::InferenceResults> getTopResult(unsigned int topCount);
