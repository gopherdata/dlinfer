 ...
 */
#include "InferenceEngineConfigurator.h"
...
std::vector<InferenceEngineConfigurator::InferenceResults> InferenceEngineConfigurator::getTopResult(
    ...
    std::vector<InferenceEngineConfigurator::InferenceResults> outputResults;
